...
function FilterContainer() {
	...
	return (
		<div className="flex w-full flex-row overflow-auto gap-[10px] mt-8 scrollbar-hide items-center justify-center sm:justify-start md:justify-start lg:justify-center">
